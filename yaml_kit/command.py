...
def parse_args():
    ...
    print_parser.add_argument("filepath", type=str, help="The yaml file to print.")

    val_parser = subparsers.add_parser("validate", help="Validate a config file.")
    val_parser.add_argument("filepath", type=str, help="The yaml file to validate.")

    newconf_parser = subparsers.add_parser(
        "new", help="Save a new default config file."
    )
    newconf_parser.add_argument(
        "filepath", type=str, help="Where to save the new config file."
    )

    update_parser = subparsers.add_parser(
        "update", help="Update one or more config files with new parameter values."
    )  # noqa
